...
- **Stunning Visual Design** – Glassmorphism cards, gradient text, smooth animations  
...
## Credits
Designed & Developed by Bugsfree Studio
Nature photos by Pexels (free for commercial use)
Icons by Feather Icons
Powered by OpenWeatherMap & NewsAPI

## License
MIT License – Feel free to fork, modify, and use in personal or commercial projects.
(Just keep the “Designed by Bugsfree Studio” footer – I’d really appreciate it!)
